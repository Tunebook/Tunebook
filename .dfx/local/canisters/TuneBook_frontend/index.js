...
import { idlFactory } from './TuneBook_frontend.did.js';
export { idlFactory } from './TuneBook_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TUNEBOOK_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./TuneBook_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the TuneBook_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./TuneBook_frontend.did.js")._SERVICE>}
 */
export const TuneBook_frontend = createActor(canisterId);
