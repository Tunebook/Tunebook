...
import { idlFactory } from './TuneBook_backend.did.js';
export { idlFactory } from './TuneBook_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TUNEBOOK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./TuneBook_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the TuneBook_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./TuneBook_backend.did.js")._SERVICE>}
 */
export const TuneBook_backend = createActor(canisterId);
