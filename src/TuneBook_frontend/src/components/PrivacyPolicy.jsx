    ...
    <div className="privacy-policy-container">
      ...
      <ul>
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to Celtic Crossroads
          Foundation, 5012 Foothills Rd, Lake Oswego, Oregon 97034.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Tunebook, accessible from{' '}
          <a
            href="https://tunebook.io"
            target="_blank"
      ...
      <ul>
        ...
        <li>To contact You with updates or other information.</li>
      </ul>
      ...
      <ul>
        <li>By email: feedback@tunebook.io</li>
        <li>
          By visiting this page on our website:{' '}
          <a
            href="https://7dysa-vqaaa-aaaam-qbema-cai.icp0.io/contact"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://7dysa-vqaaa-aaaam-qbema-cai.icp0.io/contact
          </a>
        </li>
      </ul>
    </div>
